    ...
    return (
        <div className="bg-appleBeige h-full">
            ...
            <div className="font-ThinkDifferent bg-appleBeige">
                <h2 className="font-Cooper text-center p-8 text-xl lg:text-4xl bg-appleBeige">Projects:</h2>
                <ProjectCard />
            </div>
            <div className="font-ThinkDifferent bg-appleBeige p-8">
                <h2 className="font-Cooper text-center p-8 text-xl lg:text-4xl bg-appleBeige">Skills:</h2>
            ...
            <h1 className="font-Cooper text-center p-8 text-xl md:pt-16 lg:text-4xl bg-appleBeige">About myself:</h1>
