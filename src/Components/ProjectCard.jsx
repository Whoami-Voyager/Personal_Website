    ...
    return (
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12">
            <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 p-4 m-2 bg-white rounded-lg overflow-hidden shadow-lg transition duration-300 ease-in-out transform hover:shadow-xl hover:scale-105">
                <div className="p-6">
                    <h1 className="text-2xl lg:text-3xl mb-2 font-Cooper">LandmarkLore</h1>
            ...
            <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 p-4 m-2 bg-white rounded-lg overflow-hidden shadow-lg transition duration-300 ease-in-out transform hover:shadow-xl hover:scale-105">
                <div className="p-6">
                    <h1 className="text-2xl lg:text-3xl mb-2 font-Cooper">InstaVibe</h1>
                    <h2 className="text-xl mb-2">May 2024</h2>
            ...
            <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 p-4 m-2 bg-white rounded-lg overflow-hidden shadow-lg transition duration-300 ease-in-out transform hover:shadow-xl hover:scale-105">
                <div className="p-6">
                    <h1 className="text-2xl lg:text-3xl mb-2 font-Cooper">CarChronicle</h1>
            ...
            <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 p-4 m-2 bg-white rounded-lg overflow-hidden shadow-lg transition duration-300 ease-in-out transform hover:shadow-xl hover:scale-105">
                <div className="p-4">
                    <h1 className="text-2xl lg:text-3xl mb-2 font-Cooper">TechHistoria</h1>
            ...
            <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 p-4 m-2 bg-white rounded-lg overflow-hidden shadow-lg transition duration-300 ease-in-out transform hover:shadow-xl hover:scale-105">
                <div className="p-6">
                    <h1 className="text-2xl lg:text-3xl mb-2 font-Cooper">LeMans 100</h1>
            ...
            <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 p-4 m-2 bg-white rounded-lg overflow-hidden shadow-lg transition duration-300 ease-in-out transform hover:shadow-xl hover:scale-105">
                <div className="p-6">
                    <h1 className="text-2xl lg:text-3xl mb-2 font-Cooper">My Favorite Things</h1>
