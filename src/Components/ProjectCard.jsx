function ProjectCard() {
    return (
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12">
            <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 py-12 px-6 m-2 bg-white rounded-lg overflow-hidden shadow-lg transition duration-300 ease-in-out transform hover:shadow-xl hover:scale-105">
