...
function ProjectCard() {
    return (
        <div className="flex flex-wrap justify-center gap-6 lg:gap-10">
            <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 py-12 px-6 m-6 bg-white rounded-lg overflow-hidden shadow-lg transition duration-300 ease-in-out transform lg:hover:shadow-xl lg:hover:scale-105">
